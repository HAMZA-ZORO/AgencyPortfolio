      ...
      <section class="section hero" id="home" aria-label="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">Marketing Agency</p>

            <h1 class="h1 hero-title">We are available for marketing</h1>

            <p class="hero-text">
               hena hanekteb maslan kalam 3an el agency bta3tna brief so8ir
               hena hanekteb maslan kalam 3an el agency bta3tna brief so8ir
               hena hanekteb maslan kalam 3an el agency bta3tna brief so8ir
               hena hanekteb maslan kalam 3an el agency bta3tna brief so8ir
               hena hanekteb maslan kalam 3an el agency bta3tna brief so8ir
          ...
          <figure class="hero-banner">
            <img src="landing.png" width="720" height="673" alt="hero banner" class="w-100" id="landing">
          </figure>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">service 1</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">service 2</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">service 3</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">servecie 4</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">service 5</a>
                </h3>
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">service 6</a>
                </h3>
